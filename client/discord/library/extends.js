...
module.exports = client => {
    return {
        ...
        errorEmbed: function(commandName, errorId) {
            ...
            errorEmbed.addField(`So what can I do to fix it?`, `If you need assistance with this feature, please [join our support server](https://discord.gg/hUw2VmtzhX). Once there, give this \`ErrorID\` to the support team to investigate.`);
            errorEmbed.addField('Error ID:', `\`${errorId}\``);
            errorEmbed.setTimestamp();
            errorEmbed.setFooter({
                text: '© Anomalous Games, Inc.'
            });
